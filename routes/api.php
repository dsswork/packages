...
Route::group(['prefix' => 'user', 'middleware' => 'auth:sanctum',
    'controller' => Api\UserController::class], function () {
...
Route::post('posts', [Api\PostController::class, 'store'])->middleware('auth:sanctum');
Route::put('posts/{post}/activate', [Api\PostController::class, 'activate'])->middleware('auth:sanctum');
/**
 * User packages
 */
Route::get('packages', [Api\PackageController::class, 'index']);
Route::post('packages/{id}/buy', [Api\PackageController::class, 'buy'])->middleware('auth:sanctum');
